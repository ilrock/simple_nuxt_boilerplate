...
import nuxt_plugin_axios_d2d9abbc from 'nuxt_plugin_axios_d2d9abbc' // Source: ./axios.js (mode: 'all')
import nuxt_plugin_cookieuniversalnuxt_1a8845ca from 'nuxt_plugin_cookieuniversalnuxt_1a8845ca' // Source: ./cookie-universal-nuxt.js (mode: 'all')
...
async function createApp(ssrContext) {
  ...
  if (typeof nuxt_plugin_axios_d2d9abbc === 'function') await nuxt_plugin_axios_d2d9abbc(app.context, inject)
  if (typeof nuxt_plugin_cookieuniversalnuxt_1a8845ca === 'function') await nuxt_plugin_cookieuniversalnuxt_1a8845ca(app.context, inject)
